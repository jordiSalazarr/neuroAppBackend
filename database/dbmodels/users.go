...
type User struct {
	...
	CognitoID              string      `boil:"cognito_id" json:"cognito_id" toml:"cognito_id" yaml:"cognito_id"`
	Name                   string      `boil:"name" json:"name" toml:"name" yaml:"name"`
	Email                  string      `boil:"email" json:"email" toml:"email" yaml:"email"`
	Phone                  null.String `boil:"phone" json:"phone,omitempty" toml:"phone" yaml:"phone,omitempty"`
	IsActive               bool        `boil:"is_active" json:"is_active" toml:"is_active" yaml:"is_active"`
	HasAcceptedLatestTerms bool        `boil:"has_accepted_latest_terms" json:"has_accepted_latest_terms" toml:"has_accepted_latest_terms" yaml:"has_accepted_latest_terms"`
...
var UserColumns = struct {
	...
	Phone:                  "phone",
	IsActive:               "is_active",
	HasAcceptedLatestTerms: "has_accepted_latest_terms",
...
var UserTableColumns = struct {
	...
	ID:                     "users.id",
	CognitoID:              "users.cognito_id",
	Name:                   "users.name",
	Email:                  "users.email",
	Phone:                  "users.phone",
	IsActive:               "users.is_active",
	HasAcceptedLatestTerms: "users.has_accepted_latest_terms",
...
var UserWhere = struct {
	...
	CognitoID              whereHelperstring
	Name                   whereHelperstring
	Email                  whereHelperstring
	Phone                  whereHelpernull_String
	IsActive               whereHelperbool
	HasAcceptedLatestTerms whereHelperbool
	CreatedAt              whereHelpertime_Time
	UpdatedAt              whereHelpertime_Time
}{
	ID:                     whereHelperstring{field: "`users`.`id`"},
	CognitoID:              whereHelperstring{field: "`users`.`cognito_id`"},
	Name:                   whereHelperstring{field: "`users`.`name`"},
	Email:                  whereHelperstring{field: "`users`.`email`"},
	Phone:                  whereHelpernull_String{field: "`users`.`phone`"},
	IsActive:               whereHelperbool{field: "`users`.`is_active`"},
	HasAcceptedLatestTerms: whereHelperbool{field: "`users`.`has_accepted_latest_terms`"},
...
var UserRels = struct {
	SpecialistEvaluations string
}{
	SpecialistEvaluations: "SpecialistEvaluations",
}

// userR is where relationships are stored.
type userR struct {
	SpecialistEvaluations EvaluationSlice `boil:"SpecialistEvaluations" json:"SpecialistEvaluations" toml:"SpecialistEvaluations" yaml:"SpecialistEvaluations"`
}
...
func (o *User) GetSpecialistEvaluations() EvaluationSlice {
	if o == nil {
		return nil
	}

	return o.R.GetSpecialistEvaluations()
}

func (r *userR) GetSpecialistEvaluations() EvaluationSlice {
	if r == nil {
		return nil
	}

	return r.SpecialistEvaluations
}
...
var (
	userAllColumns            = []string{"id", "cognito_id", "name", "email", "phone", "is_active", "has_accepted_latest_terms", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "cognito_id", "name", "email", "phone"}
	userColumnsWithDefault    = []string{"is_active", "has_accepted_latest_terms", "created_at", "updated_at"}
...
// SpecialistEvaluations retrieves all the evaluation's Evaluations with an executor via specialist_id column.
func (o *User) SpecialistEvaluations(mods ...qm.QueryMod) evaluationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`evaluations`.`specialist_id`=?", o.ID),
	)

	return Evaluations(queryMods...)
}

// LoadSpecialistEvaluations allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadSpecialistEvaluations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`evaluations`),
		qm.WhereIn(`evaluations.specialist_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load evaluations")
	}

	var resultSlice []*Evaluation
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice evaluations")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on evaluations")
	}
	...
	if singular {
		object.R.SpecialistEvaluations = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &evaluationR{}
			}
			foreign.R.Specialist = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.SpecialistID {
				local.R.SpecialistEvaluations = append(local.R.SpecialistEvaluations, foreign)
				if foreign.R == nil {
					foreign.R = &evaluationR{}
				}
				foreign.R.Specialist = local
				break
			}
		}
	}
...
// AddSpecialistEvaluations adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.SpecialistEvaluations.
// Sets related.R.Specialist appropriately.
func (o *User) AddSpecialistEvaluations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Evaluation) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.SpecialistID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			SpecialistEvaluations: related,
		}
	} else {
		o.R.SpecialistEvaluations = append(o.R.SpecialistEvaluations, related...)
	}
