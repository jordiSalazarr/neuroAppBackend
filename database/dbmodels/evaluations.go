...
var (
	...
	evaluationColumnsWithoutDefault = []string{"id", "patient_name", "patient_age", "specialist_mail", "specialist_id", "assistant_analysis", "storage_url", "storage_key"}
	evaluationColumnsWithDefault    = []string{"current_status", "created_at", "updated_at"}
